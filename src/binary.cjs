...
import { FIT } from './fit.cjs';

import { getFitMessage, getFitMessageBaseType } from './messages.cjs';

//import { Buffer } from 'buffer';
//var Buffer = Buffer.alloc(128000)
...
function readData(blob, fDef, startIndex, options) {
    ...
    if (fDef.type === 'string') {
        ...
        //console.log('_temp, line 97, binary');
        //console.log(_temp);
        var _temp2 = new Uint16Array(_temp).buffer;
        var _temp3 = new TextDecoder().decode(_temp2);
        //console.log(_temp2);
        //console.log(_temp3);        
        return _temp3; 
...
function readRecord(blob, messageTypes, developerFields, startIndex, options, startDate, pausedTime) {
    ...
    //setTimeout(() => {  console.log(recordHeader); }, 200000);
...
function getArrayBuffer(buffer) {
    //console.log('buffer, line 423, binary');
    //console.log(buffer);
